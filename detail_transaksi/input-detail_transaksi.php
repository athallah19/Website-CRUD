...
<head>
    ...
    <title>Aplikasi CRUD - Tambah Detail Transaksi</title>
</head>
...
<body>
    ...
    <ul class="breadcrumbs flex-row">
        ...
        <li class="link flex-row">
            <a href="../index.php"><i class="bi bi-house-door-fill"></i></a> > <a href="tampil-detail_transaksi.php">Detail Transaksi</a> > <a href="">Tambah Detail Transaksi</a>
        </li>
    </ul>
    
    <main class="table-wrap">
        <form action="proses-simpan-detail_transaksi.php" method="post" class="form">

            <label class="label" for="id_transaksi">ID Transaksi : </label>
            <input class="control number" type="number" id="id_transaksi" name="id_transaksi">
            ...
            <input class="control number" type="number" id="jumlah" name="jumlah">
