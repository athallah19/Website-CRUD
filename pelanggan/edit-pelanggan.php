...
<head>
    ...
    <title>Aplikasi CRUD - Edit Pelanggan</title>
</head>
...
<body>
	<?php
		...
		$id = $_GET['id'];
		$query = mysqli_query($koneksi, "SELECT * FROM pelanggan WHERE id='$id'")or die(mysqli_error());
    ...
    <ul class="breadcrumbs flex-row">
        ...
        <li class="link flex-row">
            <a href="../index.php"><i class="bi bi-house-door-fill"></i></a> > <a href="tampil-pelanggan.php">Pelanggan</a> > <a href="">Edit Pelanggan</a>
        </li>
    </ul>
    
    <main class="table-wrap">
		<form action="proses-edit-pelanggan.php" method="post" class="form">
            ...
            <textarea class="control-textarea" type="text" name="alamat"><?php echo $data['alamat'] ?></textarea>
