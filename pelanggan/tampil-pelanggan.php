...
<head>
    ...
    <title>Aplikasi CRUD - Pelanggan</title>
</head>
...
<body>
    <?php 
        ...
        if (isset($_POST['kata_kunci'])) {
                    ...
                    $sql="select * from pelanggan where $kolom like '%" .$kata_kunci."%' order by id asc";
                }else {
    ...
    <ul class="breadcrumbs flex-row">
        ...
        <li class="link flex-row">
            <a href="../index.php"><i class="bi bi-house-door-fill"></i></a> > <a href="">Pelanggan</a>
        </li>
    </ul>

    <section class="tambah-data">
        <a class="btn-tambah-data flex-row" href="input-pelanggan.php"><i class="bi bi-plus-circle"></i></i>Tambah Pelanggan</a> 
        <?php if (mysqli_num_rows($query) < 1) { ?><p class="kosong">Tidak ada Pelanggan ~</p><?php } ?>
    </section>
    
    <main class="table-wrap" style="margin-top: 20px;">
        <table>
            <tr>
                <th class="id-pelanggan">ID Pelanggan</th>
            ...
            <tr>
                ...
                <td>
                    <div class="action ">
                        <a class="edit" href="edit-pelanggan.php?id=<?php echo $data['id']; ?>"><i class="bi bi-pencil-fill"></i></a>
                        <a class="hapus" href="proses-hapus-pelanggan.php?id=<?php echo $data['id']; ?>"onclick=
